class QuotePdf < Prawn::Document
  ...
  def terms_and_conditions
    if @quote.is_invoice == true
      ...
      text "Les sommes étant arrondies, le total des sommes unitaires peut différer du montant total prélevé.
                  Sans escompte. En cas de retard de paiement, application d’un taux égal à trois fois le taux
                  d’intérêt et légal calculé sur le montant des sommes dues TTC à compter du 1er jour de retard
                  suivant la date de paiement portée sur la facture et comprenant un minimum de perception de 7.50€,
                  et pour les professionnels, application d’une indemnité forfaitaire pour frais de recouvrement de 40€. "
    else
      move_down 200
      text "Termes et conditions"
